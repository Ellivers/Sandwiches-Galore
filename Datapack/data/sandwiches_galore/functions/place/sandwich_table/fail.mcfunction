...
execute if entity @a[advancements={sandwiches_galore:technical/place_item_frame=true},gamemode=!creative,limit=1,predicate=sandwiches_galore:holding/sandwich_table_offhand] run scoreboard players set #temp sandwiches 0
execute if entity @a[advancements={sandwiches_galore:technical/place_item_frame=true},gamemode=!creative,limit=1,predicate=sandwiches_galore:holding/sandwich_table_mainhand] run scoreboard players set #temp sandwiches 1

loot replace block -30000000 0 8020 container.0 loot sandwiches_galore:items/sandwich_table
...
execute if score #temp sandwiches matches 0..1 run loot insert -30000000 0 8020 loot sandwiches_galore:items/sandwich_table
