summon armor_stand ~ ~-.0625 ~ {DisabledSlots:4144959,NoGravity:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["sandwiches_galore","sg.crop","sg.no_fire","sg.crop.buckwheat","sg.non_solid_blocks"],ArmorItems:[{},{},{},{id:"minecraft:netherite_hoe",Count:1b,tag:{CustomModelData:6710001}}]}
