...
execute if score #temp sandwiches matches 1 if predicate sandwiches_galore:holding/63/offhand run scoreboard players set #temp sandwiches 5
execute if score #temp sandwiches matches 2 if predicate sandwiches_galore:holding/63/mainhand run scoreboard players set #temp sandwiches 6
...
execute if score #temp sandwiches matches 5 run item modify entity @s weapon.offhand sandwiches_galore:remove_1
execute if score #temp sandwiches matches 5 run item modify entity @s weapon.offhand sandwiches_galore:add_2
execute if score #temp sandwiches matches 6 run item modify entity @s weapon.mainhand sandwiches_galore:remove_1
execute if score #temp sandwiches matches 6 run item modify entity @s weapon.mainhand sandwiches_galore:add_2
