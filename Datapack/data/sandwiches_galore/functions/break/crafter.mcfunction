particle minecraft:item minecraft:item_frame{CustomModelData:6710008} ~ ~ ~ .2 .3 .2 .08 20 force
...
execute if score #temp sandwiches matches 1 run loot spawn ~ ~ ~ loot sandwiches_galore:items/crafter
