...
execute if entity @s[tag=sg.ready] run loot spawn ~ ~.5 ~ loot sandwiches_galore:blocks/corn_ready
execute positioned ~ ~-1 ~ run kill @e[type=minecraft:armor_stand,tag=sg.crop.corn,distance=...5,sort=nearest,limit=1]
