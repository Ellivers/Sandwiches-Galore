...
execute if score #success sandwiches matches 1 on target if entity @s[gamemode=!creative] run function sandwiches_galore:crops/interact/bonemeal.take
execute if score #success sandwiches matches 1 run playsound item.bone_meal.use block @a ~ ~ ~ 1
