...
execute if score #temp sandwiches matches 1 run replaceitem entity @s weapon.offhand air
execute if score #temp sandwiches matches 2 run replaceitem entity @s weapon.mainhand air
