...
execute unless score #sg.whisk_durability sandwiches matches 98.. store result storage sandwiches:galore Item1.tag.Damage int -1 run data get storage sandwiches:galore Item1.tag.Damage -1.0000000001
execute unless score #sg.whisk_durability sandwiches matches 98.. if predicate sandwiches_galore:chance/chance_50 store result storage sandwiches:galore Item1.tag.Damage int -1 run data get storage sandwiches:galore Item1.tag.Damage -1.0000000001
