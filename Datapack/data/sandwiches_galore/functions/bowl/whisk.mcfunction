...
execute unless score #sg.whisk_durability sandwiches matches 99.. unless entity @a[advancements={sandwiches_galore:technical/right_click_armor_stand=true},gamemode=creative] run function sandwiches_galore:item_modification/replace.armor_stand_rc
