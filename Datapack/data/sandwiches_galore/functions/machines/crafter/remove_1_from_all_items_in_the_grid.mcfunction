scoreboard players remove #slot_1 sg.item_count 1
scoreboard players remove #slot_2 sg.item_count 1
scoreboard players remove #slot_3 sg.item_count 1

scoreboard players remove #slot_10 sg.item_count 1
scoreboard players remove #slot_11 sg.item_count 1
scoreboard players remove #slot_12 sg.item_count 1

scoreboard players remove #slot_19 sg.item_count 1
scoreboard players remove #slot_20 sg.item_count 1
scoreboard players remove #slot_21 sg.item_count 1
