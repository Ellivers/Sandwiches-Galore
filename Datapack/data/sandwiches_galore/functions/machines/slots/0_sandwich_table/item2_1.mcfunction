...
data modify storage sandwiches:galore Item2 set from storage sandwiches:temp root.items[{Slot:13b}]
...
execute if score #temp sg.dummy matches 1 run function sandwiches_galore:machines/reject_slots/0
execute unless score #temp sg.dummy matches 1 run function sandwiches_galore:machines/slots/0_sandwich_table/item2_2
