...
data modify storage sandwiches:galore Item2 set from storage sandwiches:temp root.items[{Slot:10b}]
...
execute unless score #temp sg.dummy matches 1 run function sandwiches_galore:machines/slots/0_sandwich_table/item1_2
