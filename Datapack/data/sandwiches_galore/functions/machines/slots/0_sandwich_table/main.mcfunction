...
execute if score #temp2 sg.dummy matches 0 unless data storage sandwiches:galore Items[{Slot:13b}] run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 13b
execute if score #temp2 sg.dummy matches 0 if data storage sandwiches:galore Items[{Slot:13b}] run function sandwiches_galore:machines/slots/0_sandwich_table/item2_1
