...
execute store result score #slot_13 sandwiches run data get storage sandwiches:galore Items[{Slot:13b}].Count
execute store result score #slot_0 sandwiches run data get storage sandwiches:galore Items[{Slot:0b}].Count
scoreboard players operation #tempcount sandwiches = #slot_13 sandwiches
scoreboard players operation #tempcount sandwiches += #slot_0 sandwiches

# Only merge until it reaches 64 items
execute if score #tempcount sandwiches matches 65.. run data modify block ~ ~ ~ Items[{Slot:13b}].Count set value 64b
...
execute unless score #tempcount sandwiches matches 65.. store result block ~ ~ ~ Items[{Slot:13b}].Count byte 1 run scoreboard players get #tempcount sandwiches
