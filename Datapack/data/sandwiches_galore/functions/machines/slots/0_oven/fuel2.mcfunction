...
scoreboard players operation #tempcount sandwiches = #slot_20 sandwiches
scoreboard players operation #tempcount sandwiches += #slot_0 sandwiches

# Only merge until it reaches 64 items
execute if score #tempcount sandwiches matches 65.. run data modify block ~ ~ ~ Items[{Slot:20b}].Count set value 64b
...
execute unless score #tempcount sandwiches matches 65.. store result block ~ ~ ~ Items[{Slot:20b}].Count byte 1 run scoreboard players get #tempcount sandwiches
