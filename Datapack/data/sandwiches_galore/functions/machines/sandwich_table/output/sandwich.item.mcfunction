...
execute store result score #sg.name_level sandwiches run data get entity @s Item.tag.SG.NameLevel
execute store result score #sg.food_level sandwiches run data get entity @s Item.tag.SG.FoodLevel
