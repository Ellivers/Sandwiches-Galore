execute unless score #sg.name_level sandwiches matches 2.. run data modify entity @s Item.tag.SG.NameLevel set value 2
execute unless score #sg.food_level sandwiches matches 5.. run data modify entity @s Item.tag.SG.FoodLevel set value 5
