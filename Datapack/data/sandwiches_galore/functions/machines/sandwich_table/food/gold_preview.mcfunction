...
execute unless data storage sandwiches:temp root.items[{Slot:10b}].tag.SG.Items[{Name:"pufferfish"}] run data modify storage sandwiches:galore Item1.tag.CustomModelData set value 6710005
execute if data storage sandwiches:temp root.items[{Slot:10b}].tag.SG.Items[{Name:"pufferfish"}] run data modify storage sandwiches:galore Item1.tag.CustomModelData set value 6710010
