...
execute unless data storage sandwiches:galore Items[{Slot:10b}].tag.Items[{Name:"pufferfish"}] run data modify block ~ ~ ~ Items[{Slot:16b}].tag.CustomModelData set value 6710005
execute if data storage sandwiches:galore Items[{Slot:10b}].tag.Items[{Name:"pufferfish"}] run data modify block ~ ~ ~ Items[{Slot:16b}].tag.CustomModelData set value 6710010