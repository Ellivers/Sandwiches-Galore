...
execute unless score #sg.name_level sandwiches matches 10.. run data modify storage sandwiches:galore Item1.tag.display.Name set value '{"italic":false,"translate":"item.sandwiches_galore.sandwich.cooked_porkchop"}'
data modify storage sandwiches:galore Item1.tag.display.Lore prepend value '[{"text":"- ","color":"gray","italic":false},{"translate":"item.minecraft.cooked_porkchop"}]'
