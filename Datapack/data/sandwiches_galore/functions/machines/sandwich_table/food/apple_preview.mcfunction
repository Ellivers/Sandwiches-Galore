...
execute unless score #sg.name_level sg.dummy matches 2.. run data modify storage sandwiches:galore Item1.tag.display.Name set value '{"italic":false,"translate":"item.sandwiches_galore.sandwich.apple"}'
