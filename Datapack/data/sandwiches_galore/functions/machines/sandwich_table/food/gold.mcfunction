...
execute unless data storage sandwiches:sandwich_table Items[{Slot:10b}].tag.Items[{Name:"pufferfish"}] run data modify entity @s Item.tag.CustomModelData set value 6710005
execute if data storage sandwiches:sandwich_table Items[{Slot:10b}].tag.Items[{Name:"pufferfish"}] run data modify entity @s Item.tag.CustomModelData set value 6710010