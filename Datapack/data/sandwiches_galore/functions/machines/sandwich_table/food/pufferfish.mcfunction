execute unless score #sg.name_level sandwiches matches 11.. run data modify entity @s Item.tag.NameLevel set value 11
...
data modify entity @s Item.tag.Items append value {Name:"pufferfish"}
