...
execute if data storage sandwiches:galore Items[{Slot:15b}] run function sandwiches_galore:machines/reject_slots/15
execute if data storage sandwiches:galore Items[{Slot:11b}] run function sandwiches_galore:machines/reject_slots/11
