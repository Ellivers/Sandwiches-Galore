...
execute if score $tickNBTChecks sandwiches matches 1 if block ~ ~ ~ minecraft:barrel[open=false] if data block ~ ~ ~ Items[{Slot:0b}] run function sandwiches_galore:machines/slots/0_sandwich_table/main
