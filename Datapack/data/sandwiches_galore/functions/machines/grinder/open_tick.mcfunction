execute if data storage sandwiches:temp root.items[{Slot:0b}] run function sandwiches_galore:machines/slots/0_grinder
...
execute unless score @s sg.process = @s sg.process if data storage sandwiches:temp root.items[{Slot:13b}] run function sandwiches_galore:machines/slots/13_grinder
