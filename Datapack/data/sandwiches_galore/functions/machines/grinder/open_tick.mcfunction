execute if data storage sandwiches:galore Items[{Slot:0b}] run function sandwiches_galore:machines/slots/0_grinder
data modify storage sandwiches:galore Items set from block ~ ~ ~ Items
execute if data storage sandwiches:galore Items[{Slot:2b}] run function sandwiches_galore:machines/reject_slots/2
...
execute if data storage sandwiches:galore Items[{Slot:20b}] run function sandwiches_galore:machines/reject_slots/20
...
execute unless score @s sg.process = @s sg.process if data storage sandwiches:galore Items[{Slot:13b}] run function sandwiches_galore:machines/slots/13_grinder
