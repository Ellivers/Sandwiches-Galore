...
scoreboard players add #heat_temp sg.dummy 6710000
execute store result block ~ ~ ~ Items[{Slot:11b,tag:{SG:{GUI_Item:1b}}}].tag.CustomModelData int 1 run scoreboard players get #heat_temp sg.dummy
