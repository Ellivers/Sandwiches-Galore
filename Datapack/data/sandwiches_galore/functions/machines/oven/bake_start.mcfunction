...
# Remove 1 fuel item
execute unless score #remove_item sg.dummy matches 0 store result block ~ ~ ~ Items[{Slot:20b}].Count byte 1 run data get storage sandwiches:galore Items[{Slot:20b}].Count 0.9999999999
